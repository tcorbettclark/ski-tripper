...
1. Use the playwright-skill
2. Open the URL !`wt step eval 'http://localhost:{{ branch | hash_port }}'`
3. Identify and interact with all the core features and user flows
