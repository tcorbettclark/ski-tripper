  ...
  return {
    ...
    properties: {
      ...
      nearestAirport: nullable(
        { type: 'string' },
        'Name of the nearest airport, e.g. "Geneva Airport"',
