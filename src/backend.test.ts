...
function asDb(db: MockDb): TablesDB {
  // biome-ignore lint/suspicious/noExplicitAny: MockDb can't structurally match TablesDB without unsafe cast
  return db as any as TablesDB
}
...
describe('getProposal', () => {
  it('returns the proposal when user is a participant', async () => {
    ...
    const db = makeDb({ getRow, listRows })
